...
driver.get("https://item.jd.com/16545891661.html")
...
for tag in tags:
    if(flag):
        ...
        print(tag.text)
sell = driver.find_element_by_xpath("//div[@class='J-comments-list comments-list ETab']//ul[@class='filter-list']//em").text
